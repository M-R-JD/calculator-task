...
var input = create("input", "col-8 border-3 border-dark text-right mt-5 mb-1");
input.setAttribute("type", "text");
input.disabled = true;
input.setAttribute(
  "style",
  `line-height:60px; background-color:pink; font-family: 'Comfortaa', cursive;`
);
input.id = "display";

var btnnumbers = createElements(
  "button",
  "btn-fluid btn-secondary text-md-center text-sm-left text-xs-left p-md-3 p-sm-4 p-xs-4 col-2",
  10
);
